...
export const getSynonyms = (term) => {
    const synonyms = {
        ...
        shoes: ['shoes', 'footwear', 'sneakers', 'sneaker', 'boots', 'sandals'],
        shoe:['shoes', 'footwear', 'sneakers', 'sneaker', 'boots', 'sandals'],
        footwear: ['footwear', 'shoes', 'sneakers', 'sneaker', 'boots', 'sandals'],
